...
export const en = {
  ...
  "modal.liveModels": "Live model discovery",
  "modal.liveModelsHint": "When off, the proxy uses only the configured static model list instead of fetching from the provider.",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.liveModels": "Live model discovery",
  "pws.liveModelsHint": "When off, the proxy uses only the configured static model list instead of fetching from the provider.",
