...
export const ko: Record<TKey, string> = {
  ...
  "modal.liveModels": "라이브 모델 검색",
  "modal.liveModelsHint": "꺼져 있으면 프로바이더에서 가져오는 대신 구성된 정적 모델 목록만 사용합니다.",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.liveModels": "라이브 모델 검색",
  "pws.liveModelsHint": "꺼져 있으면 프로바이더에서 가져오는 대신 구성된 정적 모델 목록만 사용합니다.",
