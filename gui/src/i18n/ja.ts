...
export const ja: Record<TKey, string> = {
  ...
  "modal.liveModels": "ライブモデル検出",
  "modal.liveModelsHint": "オフにすると、プロバイダーからの取得ではなく、設定済みの静的モデルリストのみを使用します。",
  ...
  "pws.liveModels": "ライブモデル検出",
  "pws.liveModelsHint": "オフにすると、プロバイダーからの取得ではなく、設定済みの静的モデルリストのみを使用します。",
